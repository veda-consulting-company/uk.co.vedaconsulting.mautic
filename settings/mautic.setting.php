...
return [
  ...
  'mautic_event_segment_text' => [
    'group_name' => 'Mautic Settings',
    'group' => 'mautic',
    'name' => 'mautic_event_segment_text',
    'type' => 'String',
    'add' => '5.0',
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => 'Prefix/Suffix to use when creating a Mautic Segment for a CiviCRM Event.',
    'title' => 'Event Segment Suffix',
    'default' => ':EventReg',
    'is_required' => FALSE,
    'help_text' => '',
    'html_type' => 'text',
  ...
  'mautic_event_segment_suffix_position' => [
    'group_name' => 'Mautic Settings',
    'group' => 'mautic',
    'name' => 'mautic_event_segment_suffix_position',
    'type' => 'String',
    'add' => '5.0',
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => '',
    'title' => 'Segment Suffix position',
    'help_text' => '',
    'html_type' => 'radio',
    'default' => 'after',
    'options' => [
      'before' => ts('Before Event Title'),
      'after' => ts('After Event Title'),
    ],
    'html_attributes' => [
      'size' => 50,
    ],
