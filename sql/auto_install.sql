...
CREATE TABLE `civicrm_mauticwebhook` (
     ...
     `webhook_trigger_type` varchar(256)    COMMENT 'Mautic Webhook trigger event type.',
...
,          CONSTRAINT FK_civicrm_mauticwebhook_contact_id FOREIGN KEY (`contact_id`) REFERENCES `civicrm_contact`(`id`) ON DELETE CASCADE,          CONSTRAINT FK_civicrm_mauticwebhook_activity_id FOREIGN KEY (`activity_id`) REFERENCES `civicrm_activity`(`id`) ON DELETE CASCADE  
)    ;
